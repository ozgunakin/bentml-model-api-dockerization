...
setuptools.setup(
    name='LogisticModel',
    version='20210709112532_463C04',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - LogisticModel:20210709112532_463C04
...
A minimum prediction service exposing a Scikit-learn model""",
    ...
    package_data={
        'LogisticModel': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'LogisticModel=LogisticModel:cli',
        ],
    }
)
